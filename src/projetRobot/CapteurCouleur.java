...
public class CapteurCouleur {
	...
	public void CalibrerWhite() {
		// appelle cette m�thode lorsque le robot est plac� sur la couleur blanche.
		// actualise la valeur ID associ�e � la couleur blanche
		RealIDWhite = mesureColorID();
		
	}
	
	public boolean isWhite() {
		//Renvoie true si le capteur couleur mesure un ID equivalent � Blanc.
